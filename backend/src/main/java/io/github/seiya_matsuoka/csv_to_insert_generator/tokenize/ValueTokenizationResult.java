...
public final class ValueTokenizationResult {
   ...
   * 成功結果を生成する。
   *
   * @param tokenized トークン化結果
   * @return 成功結果
   * @throws NullPointerException tokenizedがnullの場合
   */
  public static ValueTokenizationResult success(TokenizedCsv tokenized) {
    return new ValueTokenizationResult(
   ...
   */
  public static ValueTokenizationResult failure(List<ValidationError> errors, boolean truncated) {
    return new ValueTokenizationResult(null, errors, truncated);
  }
